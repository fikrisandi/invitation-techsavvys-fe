...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden grad-yy-cover geo-yy">
      <div className="relative z-10 text-center mx-auto" style={{ padding: "120px 20px", maxWidth: "100%", width: "100%" }}>
        ...
        <div className="reveal-up delay-2" style={{ marginBottom: "60px" }}>
          ...
          <h1 style={{ fontFamily: "var(--font-yy-script)", fontSize: "clamp(2.5rem, 10vw, 5rem)", lineHeight: 1.05, wordBreak: "break-word", overflowWrap: "break-word", maxWidth: "100%" }}>
            <span className="shimmer-yy" style={{ display: "inline-block", maxWidth: "100%" }}>{groom.nickname}</span>
            ...
            <span className="shimmer-yy" style={{ display: "inline-block", maxWidth: "100%" }}>{bride.nickname}</span>
          </h1>
        </div>
