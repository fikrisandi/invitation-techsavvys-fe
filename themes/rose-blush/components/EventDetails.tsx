    ...
    <section id="event" style={{ background: "var(--color-rb-bg-alt)", padding: "120px 32px" }}>
      <div style={{ maxWidth: "640px", margin: "0 auto" }}>
        ...
        {mapGroups.map((event, i) => (
          <div key={`map-${i}`} className="reveal-up" style={{ marginBottom: "32px" }}>
            {event.mapsEmbedSrc && (
              <div className="card-rb" style={{ padding: "8px", marginBottom: "16px" }}>
            ...
            {event.mapsUrl && (
              <div style={{ textAlign: "center" }}>
                <a href={event.mapsUrl} target="_blank" rel="noopener noreferrer" className="btn-rb-outline">
