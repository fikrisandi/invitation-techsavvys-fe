...
function PersonCard({ person, role }: { person: { name: string; nickname: string; parents?: string; photo?: string }; role: string }) {
  return (
    <div className="card-rb reveal-up" style={{ padding: "36px 28px", textAlign: "center", flex: "1 1 260px", maxWidth: "320px" }}>
      ...
      <p style={{ fontFamily: "var(--font-rb-display)", fontSize: "13px", color: "var(--color-rb-text)", fontStyle: "italic", marginBottom: "12px" }}>{person.name}</p>
      {person.parents && (
